...
N?u b?nh nhân n?i trú thì gi?m 10% ti?n thu?c và 12% ti?n ?; n?u b?nh nhân ngo?i trú thì gi?m 10% ti?n di?u tr?
...
class BN_I : public Person{
    ...
    double tthuoc, tieno; //tien thuoc va tien o
    public:
    BN_I()
    {
        this->tbcd=" ";
